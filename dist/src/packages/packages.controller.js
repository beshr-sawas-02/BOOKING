...
__decorate([
    (0, common_1.Post)(':id/hotels/:hotelId'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)('admin'),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    ...
    __metadata("design:returntype", void 0)
], PackagesController.prototype, "addHotel", null);
__decorate([
    (0, common_1.Delete)(':id/hotels/:hotelId'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)('admin'),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Param)('hotelId', common_1.ParseIntPipe)),
    ...
    __metadata("design:paramtypes", [Number, Number]),
    __metadata("design:returntype", void 0)
], PackagesController.prototype, "removeHotel", null);
